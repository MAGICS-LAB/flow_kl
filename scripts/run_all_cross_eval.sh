...
python -m part1.experiment --schedule a1 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A2"

echo ""
echo "Running (a1 vs a3 model) ..."
python -m part1.experiment --schedule a1 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A3"

echo ""
echo "Running (a2 vs a1 model) ..."
python -m part1.experiment --schedule a2 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A1"

echo ""
echo "Running (a2 vs a3 model) ..."
python -m part1.experiment --schedule a2 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A3"

echo ""
echo "Running (a3 vs a1 model) ..."
python -m part1.experiment --schedule a3 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A1"

echo ""
echo "Running (a3 vs a2 model) ..."
python -m part1.experiment --schedule a3 --num_samples 2000 --num_times 101 --num_seeds 3 --load_model "$MODEL_A2"
